    ...
    <div className={`${cardCls} p-6 space-y-4`}>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-1">
          ...
          <input type="range" min={4} max={16} value={cur.sleepHours} onChange={(e) => save({ sleepHours: parseInt(e.target.value) })} aria-label={`Hours of sleep: ${cur.sleepHours}`} aria-valuetext={`${cur.sleepHours} hours`} className="w-full" style={{ accentColor: "var(--arbor-clay)" }} />
        </div>
        <div className="space-y-1">
