          ...
          <form ref={formRef} onSubmit={submitLog} className={`${cardCls} p-5 space-y-4 text-sm`}>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <input type="range" min="1" max="5" value={newLogIntensity} onChange={(e) => setNewLogIntensity(parseInt(e.target.value))} className="w-full mt-2.5" style={{ accentColor: "var(--arbor-primary)" }} />
