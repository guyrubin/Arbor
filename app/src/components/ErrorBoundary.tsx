    ...
    if (hasError) {
      return (
        <div className="bg-white rounded-3xl p-8 text-center space-y-4 max-w-md mx-auto mt-10" style={{ border: "1px solid rgba(189,79,116,0.30)", boxShadow: "0 2px 10px rgba(41,51,63,0.05)" }}>
          <div className="w-12 h-12 mx-auto rounded-2xl flex items-center justify-center" style={{ background: "var(--arbor-pink-soft)" }}>
            <AlertTriangle className="w-6 h-6" style={{ color: "var(--arbor-pink-ink)" }} />
          </div>
