...
export const en: Dict = {
  ...
  "vl.mixValue": "{heCount} of the words you've logged so far are in Hebrew, {enCount} in English.",
  ...
  "set.plan.familyDesc": "Everything in Plus, plus one co-parent invite. They see a read-only view of what you choose to share, and you can revoke it any time.",
  ...
  "prac.speech.progress.coachPrompt": "{name} (age {age}) is practicing the {sound} sound at the {level} level, with {tries} tries logged so far. Give me one playful way to practice it during daily routines this week, and what 'normal progress' looks like.",
...
export const he: Dict = {
  ...
  "vl.mixValue": "{heCount} מהמילים שתיעדתם עד כה הן בעברית, {enCount} באנגלית.",
  ...
  "set.plan.familyDesc": "כל מה שבפלוס, ובנוסף הזמנה אחת להורה שותף. הם מקבלים צפייה בלבד במה שבחרתם לשתף, וניתן לבטל בכל רגע.",
  ...
  "prac.speech.progress.coachPrompt": "{name} (בן/בת {age}) מתרגל את הצליל {sound} ברמת {level}, עם {tries} ניסיונות שתועדו עד כה. תנו לי דרך משחקית אחת לתרגל את זה במהלך השגרה היומיומית השבוע, ואיך נראית \"התקדמות תקינה\".",
