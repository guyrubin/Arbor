...
export const en: Dict = {
  ...
  // Reviewer preview (review.*) — GD-1: visible ONLY to the appointed clinical
  // reviewer (server allow-list). The banner string is pinned by tests.
  "review.draftBanner": "DRAFT — under clinical review, not published",
  "review.queueOpen": "Review queue",
  "review.queueTitle": "Clinical review queue",
  "review.queueSub": "Visible only to the appointed clinical reviewer. Nothing here is published — approval stamps land in governance, never in the app.",
  "review.status.draft": "Draft",
  "review.status.approved": "Approved",
  "review.status.retired": "Retired",
  "review.status.queued-signoff": "Queued for clinical sign-off",
  "review.status.shipped-reviewed": "Live — registry-reviewed",
  "review.spokenCopy": "Spoken copy",
  "review.resourceCopy": "Resource copy",
...
export const he: Dict = {
  ...
  // Reviewer preview (review.*) — GD-1
  "review.draftBanner": "טיוטה — בבדיקה קלינית, לא פורסם",
  "review.queueOpen": "תור בדיקה",
  "review.queueTitle": "תור הבדיקה הקלינית",
  "review.queueSub": "גלוי רק לסוקרת הקלינית הממונה. שום דבר כאן אינו מפורסם — חותמות אישור נרשמות בשכבת הממשל, לעולם לא באפליקציה.",
  "review.status.draft": "טיוטה",
  "review.status.approved": "מאושר",
  "review.status.retired": "הוצא משימוש",
  "review.status.queued-signoff": "ממתין לאישור קליני",
  "review.status.shipped-reviewed": "פעיל — נבדק מול המרשם",
  "review.spokenCopy": "נוסח מדובר",
  "review.resourceCopy": "נוסח המשאבים",
  "review.reviewedBy": "נבדק על ידי",
  // Language Lab (lang.*)
