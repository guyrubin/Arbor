...
export const en: Dict = {
  ...
  "nav.tools": "Tools",
  "nav.tool.0": "Log a Moment",
  "nav.tool.1": "Day Windows",
  "nav.tool.2": "Routines",
  "nav.tool.3": "Weekly Report",
  "nav.tool.4": "Behavior Logs",
  "nav.tool.5": "Bedtime Stories",
  "nav.tool.6": "Reminders",
  "nav.tool.7": "The Science",
  "nav.tool.8": "Arbor Plus",
  "nav.tool.9": "Practice",
  "nav.tool.10": "Growth Plans",
  "nav.tool.11": "Hero Comics",
  "nav.tool.12": "Family Formation",
  "nav.tool.13": "School Brief",
  "nav.tool.14": "My Care Team",
  "nav.tool.15": "Trusted Sharing",
  "nav.tool.16": "Appointments",
  "nav.tool.17": "Child Memory",
...
export const he: Dict = {
  ...
  "nav.overview": "סקירה",
  "nav.tools": "כלים",
  "nav.tool.0": "תיעוד רגע",
  "nav.tool.1": "חלונות היום",
  "nav.tool.2": "שגרות",
  "nav.tool.3": "דוח שבועי",
  "nav.tool.4": "יומן התנהגות",
  "nav.tool.5": "סיפורי לילה",
  "nav.tool.6": "תזכורות",
  "nav.tool.7": "המדע",
  "nav.tool.8": "ארבור פלוס",
  "nav.tool.9": "תרגול",
  "nav.tool.10": "תוכניות התפתחות",
  "nav.tool.11": "קומיקס גיבורים",
  "nav.tool.12": "בניית משפחה",
  "nav.tool.13": "תקציר לגן/בית הספר",
  "nav.tool.14": "צוות הטיפול שלי",
  "nav.tool.15": "שיתוף מהימן",
  "nav.tool.16": "פגישות",
  "nav.tool.17": "זיכרון הילד",
