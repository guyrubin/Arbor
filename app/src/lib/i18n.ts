...
export const en: Dict = {
  ...
  "handoff.empty.body": "Click \"Compile brief summary\" above to generate a custom printable support brief using {name}'s current milestones and logs.",
...
export const he: Dict = {
  ...
  "handoff.empty.body": "לחצו על \"הפקת סיכום קצר\" למעלה כדי ליצור סיכום תמיכה מותאם וניתן להדפסה לפי אבני הדרך והרישומים הנוכחיים של {name}.",
