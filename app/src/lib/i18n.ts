...
export const en: Dict = {
  ...
  "nav.tab.learn": "Library",
  "nav.tab.smart-reminders": "Gentle Reminders",
  "nav.tab.science": "The Science",
  // Learn Library
  "learn.title": "Learn Library",
  "learn.subtitle": "Short, evidence-informed reads on how children grow — sized for the minutes you actually have.",
  "learn.search": "Search topics…",
  "learn.pickedTitle": "Picked for {name}",
  "learn.yourChild": "your child",
  "learn.whyAge": "Chosen for {name}'s age.",
  "learn.whyFull": "Chosen for {name}'s age and your Development Map.",
  "learn.all": "All",
  "learn.saved": "Saved",
  "learn.allReads": "Browse the library",
  "learn.count": "{n} reads",
  "learn.minutes": "{n} min",
  "learn.ages": "Ages {min}–{max}",
  "learn.readCard": "Read",
  "learn.back": "Back to library",
  "learn.keyPoints": "Key points",
  "learn.fullRead": "The full read",
  "learn.tryToday": "Try this today",
  "learn.save": "Save",
  "learn.savedLabel": "Saved",
  "learn.share": "Share",
  "learn.copied": "Copied",
  "learn.emptySearch": "No reads match “{q}” yet.",
  "learn.clearSearch": "Clear search",
  "learn.emptySaved": "Nothing saved yet. Tap the bookmark on any card to keep it here.",
  "learn.provenance": "General developmental education from Arbor's curated library — not an assessment of your child. If something keeps worrying you, a conversation with a professional is always a good step.",
  // Practice Studio (parent launcher)
  "practice.studio.title": "Practice Studio",
  "practice.studio.subtitle": "Ten skill worlds {name} plays as their hero. Pick a focus, hand over the device, or launch Kid Mode.",
  "practice.studio.kidmode.title": "Kid Mode",
  "practice.studio.kidmode.sub": "The parent-locked play space — your child can't exit or delete anything.",
  "practice.studio.kidmode.cta": "Launch Kid Mode",
  "practice.studio.worlds": "The worlds",
  "practice.studio.count": "{n} worlds",
  "practice.studio.sessions": "{n} sessions",
  "practice.studio.openDirect": "Open now",
  "practice.studio.openKidmode": "In Kid Mode as “{world}”",
  "practice.studio.note": "Practice is play, not assessment — sessions feed the same development picture you already see, always as counts, never as a score.",
  "practice.world.speech.name": "Speech & Sounds",
  "practice.world.speech.skill": "Articulation and sound practice with instant, friendly feedback.",
  "practice.world.words.name": "Word World",
  "practice.world.words.skill": "Everyday language strategies, practiced through play.",
  "practice.world.feelings.name": "Feelings Lab",
  "practice.world.feelings.skill": "Naming and handling emotions, one playful scene at a time.",
  "practice.world.mimic.name": "Mimic Studio",
  "practice.world.mimic.skill": "Imitation and expression — the social-attunement gym.",
  "practice.world.adventures.name": "Story Quest",
  "practice.world.adventures.skill": "Listening comprehension through story adventures.",
  "practice.world.memory.name": "Working Memory",
  "practice.world.memory.skill": "Holding and using information — matching and memory games.",
  "practice.world.reading.name": "Letters & Reading",
  "practice.world.reading.skill": "Phonics, sight words and letter tracing, forged into words.",
  "practice.world.rhythm.name": "Rhythm & Timing",
  "practice.world.rhythm.skill": "Keeping the beat — timing, attention and coordination.",
  "practice.world.movement.name": "Movement & Poses",
  "practice.world.movement.skill": "Gross-motor play: balance, poses and body control.",
  "practice.world.logic.name": "Patterns & Logic",
  "practice.world.logic.skill": "Spotting patterns — early reasoning and math thinking.",
  "learn.whyFullLogs": "Chosen for {name}'s age, your Development Map, and the moments you've logged.",
  "learn.whyAgeLogs": "Chosen for {name}'s age and the moments you've logged.",
  "learn.askContext": "We've also been logging related moments recently — please factor them in.",
  "learn.listen": "Listen",
  "learn.listening": "Stop",
  "learn.addToday": "Add to today",
  "learn.addedToday": "Added to today",
  "learn.pulseAsk": "Was this read helpful?",
  "learn.pulseYes": "Helpful",
  "learn.pulseNo": "Not really",
  ...
  "learn.trailAll": "Open the library",
  "today.action.eyebrow.learn": "From your Learn read",
  ...
  "consult.reviewed": "I reviewed the summary and chose what to share.",
  "consult.contract.review": "Review first",
  "consult.contract.reviewBody": "Read the exact packet before any copy, download, export, or send action unlocks.",
  "consult.contract.control": "You choose",
  "consult.contract.controlBody": "Uncheck any detail. Arbor keeps the handoff useful without oversharing.",
  ...
  "coach.contract.context": "Reads context",
  "coach.contract.contextBody": "Uses profile, moments, milestones, and approved memory when available.",
  "coach.contract.next": "Gives one step",
  "coach.contract.nextBody": "Turns the answer into something you can try today.",
  "coach.contract.memory": "Asks to remember",
  "coach.contract.memoryBody": "Durable facts wait for your approval before becoming memory.",
  "coach.contract.care": "Routes concerns",
  "coach.contract.careBody": "When a specialist is better, Arbor points you to Care Network.",
  ...
  "coach.reject": "Reject",
  "coach.memEmpty": "Ask the coach a question, and Arbor will suggest what's worth remembering — for your review. Nothing is remembered yet.",
  ...
  "coach.error": "Arbor couldn't bring you an answer just now. Your question is safe — try again.",
  ...
  "coach.cards.frame": "Developmental frame",
  ...
  "coach.frame.aim": "Aim",
  "coach.frame.twoAxes": "Warmth ↔ Structure",
  "coach.frame.story": "Story",
  "coach.frame.shadow": "Hard feeling",
  "coach.frame.marriage": "Co-parent",
  "coach.frame.shepherd": "Who holds next",
  // COACH-1 — prominent escalation panel headline (quiet tier = coach.escalate.title).
  "coach.escalate.headline": "Reach out for help if",
  // COACH-1 — CoachTab toasts.
  "coach.toast.planSeeded": "Seeded the plan generator — tap Generate",
  "coach.toast.draftingLog": "Drafting a log from this moment…",
  "coach.toast.logDrafted": "Arbor drafted a log — review and save",
  "coach.toast.notePrefilled": "Capture the moment — a note is pre-filled",
  ...
  "coach.lens.fewer": "Fewer options",
  // COACH-1 — TrustSafetyBar note under the coach thread.
  "coach.trust.note": "Arbor's read of this answer",
  // COACH-1 — TrustSafetyBar (shared kit). Posture lines only — never a graded
  // child verdict (clinical firewall): escalation semantics preserved, no grades.
  "kit.trust.elevated": "Worth a conversation with a professional",
  "kit.trust.calm": "Parent observations — not a diagnosis",
  "kit.trust.nonDiagnostic": "Non-diagnostic guidance",
  "kit.trust.escalation": "Escalation available",
  "kit.trust.talkPro": "Talk to a professional →",
  ...
  "scholar.subtitle": "Decades of child-development wisdom, one lens at a time. Pick a scholar to bring their perspective — and an example question — straight into Ask Arbor.",
  ...
  "beh.capture.hideDetails": "Show fewer details",
  ...
  "beh.analyze": "Find the pattern",
  "beh.synthesizing": "Pulling it together…",
  ...
  "beh.generateScript": "Get the words to say",
  "beh.regenerateScript": "Try different words",
  "beh.analyzing": "Looking for the pattern…",
  ...
  "hm.cat.limits": "Limits",
  "hm.cat.relationships": "Relationships",
  "hm.cat.separation": "Separation",
  "hm.cat.routines": "Routines",
  "hm.cat.transitions": "Transitions",
  "hm.section.doNow": "Do now",
  "hm.section.sayThis": "Say this",
  "hm.section.avoid": "Avoid",
  ...
  "hm.today.eyebrow": "From your recent moments",
  // Language Lab (lang.*)
  ...
  "lang.noLangs": "No languages set for {first} yet. Add the languages spoken at home in their profile, and the daily practice below will fit them.",
  ...
  // UND-1 — wave-2 observation buttons (were inline uiLang ternaries in MilestonesTab).
  "ms.observePrompt": "What have you noticed?",
  "ms.observe.yes": "Yes",
  "ms.observe.notSure": "Not sure",
  "ms.observe.notYet": "Not yet",
  ...
  // plans
  "plan.title": "Action Plans",
  "plan.subtitle": "Turn a recurring challenge into a calm, step-by-step plan with the exact words to say.",
  ...
  // UND-1: renamed from "monitor.ontrack" — key NAMES on this surface avoid the
  // wave-3 banned verdict class too, so source scans stay clean.
  "monitor.calm": "Nothing stands out right now. Keep logging — Arbor will let you know if anything is worth raising.",
  ...
  /* ══ UND-1 — Development Check localization (P0 HE/EN parity on the highest-
     trust clinical surface). Every ScreeningFlow/Screening UI string, the
     TrustSafetyBar disclaimer, the item-bank prompts (screen.item.<id>) and the
     monitoring watch-note templates resolve through these keys. CLINICAL
     FIREWALL — no key value here may carry a verdict register (the wave-3
     banned class); observational counts only. The wave-3 banned-token scan
     covers every screen-prefixed key line. HE translations of the clinical
     item prompts and result framing are first drafts queued for the named
     clinical reviewer (GD-10). ══ */
  "screen.eyebrow": "Growth",
  "screen.trustNote": "Arbor is not a medical device and does not diagnose. This is a parent-awareness check — a conversation with a professional never hurts.",
  ...
  "screen.seeResult": "See result",
  "screen.answer.yes": "Yes",
  "screen.answer.sometimes": "Sometimes",
  "screen.answer.not_yet": "Not yet",
  "screen.result.title.watch": "A few areas worth a conversation",
  "screen.result.title.calm": "Nothing stands out for {name} across these areas right now",
  "screen.result.body.watch": "This isn't a diagnosis — it's a prompt to check in with a professional, which never hurts.",
  "screen.result.body.calm": "Keep noticing and re-check in a few weeks. Development changes fast.",
  "screen.chip.watch": "Worth a conversation",
  "screen.chip.calm": "Nothing to raise",
  "screen.next.title": "Your next step",
  "screen.next.summary": "Prepare a professional summary",
  "screen.next.findPro": "Find a professional",
  "screen.next.retake": "Retake",
  "screen.toast.handoff": "Build a handoff to share this with a professional",
  "screen.safetyNote": "If you ever notice a loss of skills your child already had, or you feel something is wrong, contact a professional directly — don't wait for a re-check.",
  "screen.monitor.exportOpen": "Opening a provider-ready summary to print or save as PDF",
  "screen.monitor.exportBlocked": "This summary could not be exported — it did not pass Arbor's safety check.",
  "screen.monitor.headline.one": "One area is worth mentioning to your provider",
  "screen.monitor.headline.many": "{n} areas are worth mentioning to your provider",
  "screen.monitor.note.milestone.one": "One {area} skill that's typically seen by now hasn't been noted yet for {name}.",
  "screen.monitor.note.milestone.many": "{n} {area} skills typically seen by now haven't been noted yet for {name}.",
  "screen.monitor.note.pattern": "You've logged {n} intense, unsettled {area} moments recently.",
  "screen.monitor.note.close": "Children develop at their own pace and this isn't a diagnosis — it's simply worth mentioning to your provider at your next visit.",
  // The six monitored/screened developmental domains (display labels).
  "screen.domain.attachment_regulation": "Attachment & regulation",
  "screen.domain.language_communication": "Language & communication",
  "screen.domain.cognition_executive_function": "Thinking & attention",
  ...
  "screen.band.2-3": "2–3 years",
  "screen.band.3-5": "3–5 years",
  "screen.band.5-8": "5–8 years",
  "screen.band.8-12": "8–12 years",
  // Item-bank prompts (screen.item.<item id> — EN mirrors lib/screening.ts AGE_BANDS).
  "screen.item.b01-soc1": "Smiles back at you and seeks your face.",
  "screen.item.b01-lang1": "Coos, babbles, or makes sounds back and forth with you.",
  "screen.item.b01-att1": "Settles with comfort from a familiar adult.",
  "screen.item.b01-mot1": "Reaches for toys and follows things with their eyes.",
  "screen.item.b01-cog1": "Looks for a toy or face that's hidden or moved.",
  "screen.item.b12-lang1": "Uses a few words and tries to copy words you say.",
  "screen.item.b12-soc1": "Points to show you something interesting.",
  "screen.item.b12-soc2": "Looks at you and shares a smile during play (shared attention).",
  "screen.item.b12-mot1": "Walks on their own and is steady on their feet.",
  "screen.item.b12-cog1": "Follows a simple instruction like 'give me the ball.'",
  "screen.item.b12-ind1": "Settles to sleep and stays asleep reasonably for their age.",
  "screen.item.b23-lang1": "Puts two or more words together ('more milk').",
  "screen.item.b23-lang2": "Most of what they say is understandable to family.",
  "screen.item.b23-soc1": "Notices other children and plays near or with them.",
  "screen.item.b23-soc2": "Responds to their name and makes eye contact during talk.",
  "screen.item.b23-att1": "Recovers from upset with help within a reasonable time.",
  "screen.item.b23-ind1": "Eats a reasonable range of foods and textures.",
  "screen.item.b35-lang1": "Speaks in short sentences a stranger can mostly understand.",
  "screen.item.b35-soc1": "Takes turns and plays cooperative, pretend games with others.",
  "screen.item.b35-cog1": "Follows two-step instructions and stays with a task briefly.",
  "screen.item.b35-att1": "Manages most transitions and disappointments without prolonged meltdowns.",
  "screen.item.b35-ind1": "Manages basics like dressing, toileting and sleep for their age.",
  "screen.item.b35-mot1": "Copes with everyday sounds, textures and busy spaces.",
  "screen.item.b58-cog1": "Sustains attention on a task and follows multi-step routines.",
  "screen.item.b58-soc1": "Makes and keeps friendships and resolves small conflicts.",
  "screen.item.b58-lang1": "Holds a back-and-forth conversation and follows a story.",
  "screen.item.b58-att1": "Calms after upset and bounces back from setbacks.",
  "screen.item.b58-ind1": "Sleeps well and manages morning/school routines with support.",
  "screen.item.b812-cog1": "Organizes schoolwork and manages attention for their age.",
  "screen.item.b812-soc1": "Maintains friendships and navigates social ups and downs.",
  "screen.item.b812-att1": "Talks about feelings and recovers from hard days.",
  "screen.item.b812-ind1": "Handles daily responsibilities and sleeps adequately.",
  ...
  "sec.sharing.form.nothingDefault": "Nothing is selected by default. Only the sections you choose will be visible.",
  "sec.sharing.form.what": "What to share",
  "sec.sharing.form.duration": "Access duration",
  "sec.sharing.form.review": "Review before sharing",
  "sec.sharing.review.recipient": "Recipient",
  "sec.sharing.review.canSee": "They can see",
  "sec.sharing.review.note": "Arbor will share only this summary. Access can be revoked at any time. Review the recipient and sections carefully before approving.",
  "sec.sharing.review.back": "Back and edit",
  "sec.sharing.review.approve": "Approve & share",
  "sec.sharing.review.working": "Sharing…",
  "sec.sharing.team.title": "Coordinating around {name}",
  "sec.sharing.active.loading": "Loading shares…",
  "sec.sharing.active.empty": "Nothing is shared right now. Add a co-parent or a teacher to get started.",
  "sec.sharing.revoke": "Revoke access",
  "sec.sharing.noScopes": "No scopes",
  "sec.sharing.expires": "Expires {date}",
  "sec.sharing.inbound.title": "Shared with you",
  "sec.sharing.inbound.aChild": "A child",
  "sec.sharing.inbound.fromRole": "from {owner} · you are {role}",
  // CARE-2 — the recipient read-only shared view.
  "sec.sharing.viewer.open": "View what's shared",
  "sec.sharing.viewer.title": "Shared with you — {name}",
  "sec.sharing.viewer.loading": "Loading the shared view…",
  "sec.sharing.viewer.readOnly": "Read-only view prepared by {owner} via Arbor. Only the sections they approved — observations and counts, never a diagnosis.",
  "sec.sharing.viewer.empty": "Nothing here yet — the shared sections have no entries so far.",
  "sec.sharing.viewer.ended": "This share has ended — it was revoked or has expired.",
  "sec.sharing.viewer.blocked": "This share can't be displayed right now.",
  "sec.sharing.viewer.error": "Couldn't load the shared view. Please try again.",
  "sec.sharing.viewer.close": "Close",
  "sec.sharing.data.title": "Your data",
  "sec.sharing.data.export": "Export all data",
  "sec.sharing.data.exportNote": "Parent-initiated export of Arbor data. Non-diagnostic.",
  "sec.sharing.history.title": "Sharing history",
  "sec.sharing.history.empty": "No past shares yet. When a share ends or is revoked, it stays listed here with its dates.",
  "sec.sharing.history.createdOn": "Shared {date}",
  "sec.sharing.history.revokedOn": "Revoked {date}",
  "sec.sharing.history.expiredOn": "Expired {date}",
  "sec.sharing.audit.shared": "Shared {scopes} with {email} ({role})",
  "sec.sharing.audit.revoked": "Access revoked for {email}",
  "sec.sharing.audit.exported": "You exported all of {name}'s data",
  "sec.sharing.audit.createError": "Could not create share: {message}",
  "sec.sharing.audit.revokeError": "Could not revoke: {message}",
  "share.role.co_parent": "Co-parent",
  "share.role.viewer": "Viewer",
  "share.role.professional": "Professional",
  "share.scope.story_timeline": "Story timeline",
  "share.scope.weekly_insight": "Weekly Insight",
  "share.scope.behavior_patterns": "Behavior patterns",
  "share.scope.milestones": "Milestones",
  "share.scope.report_teacher": "Teacher Handoff",
  "share.scope.report_therapist": "Therapist Summary",
  "share.scope.report_pediatrician": "Pediatrician Summary",
  "share.scope.report_slp": "Speech-Language (SLP) Summary",
  "share.scope.report_behavioral_health": "Behavioral Health Summary",
  "share.duration.30d": "30 days",
  "share.duration.60d": "60 days",
  "share.duration.term": "End of term",
  "share.duration.until_revoked": "Until revoked",
  // CARE-1 — real GDPR erasure flow: typed-name confirm → POST /privacy/erase
  // via eraseEverything → provable DeletionReceipt (counts only, never scores).
  "sec.sharing.delete.btn": "Delete child data",
  "sec.sharing.delete.title": "Delete {name}'s data",
  "sec.sharing.delete.body": "This permanently erases {name}'s data — every log, plan, share grant, consent record and memory event, on this device and on the server. This cannot be undone.",
  "sec.sharing.delete.typeToConfirm": "Type {name} to confirm",
  "sec.sharing.delete.confirm": "Permanently delete",
  "sec.sharing.delete.working": "Deleting…",
  "sec.sharing.delete.cancel": "Cancel",
  "sec.sharing.delete.error": "Something went wrong while deleting. Please try again.",
  "sec.sharing.receipt.title": "Deletion complete",
  "sec.sharing.receipt.body": "{name}'s data was permanently erased on {date}. Keep this receipt as your record.",
  "sec.sharing.receipt.memoryEvents": "Memory events erased",
  "sec.sharing.receipt.shares": "Share grants erased",
  "sec.sharing.receipt.consents": "Consent records erased",
  "sec.sharing.receipt.done": "Done",
  ...
  "ob.subtitle": "Two quick things, and Arbor starts getting to know your child.",
  ...
  // TODAY-5/PLAT-4 — onboarding progressbar aria-label (was hardcoded English).
  "ob.progress.step": "Step {step} of {total}",
  ...
  "set.plan.price.perMonth": "{plan} — {price}/month",
  "set.plan.price.perMonthAnnual": "{plan} — {price}/month, billed yearly ({total})",
  "set.plan.cancelAnytime": "Cancel anytime.",
  ...
  "set.plan.restore": "Restore purchases",
  "set.plan.restoreDone": "Done — your plan is up to date.",
  "set.acctDel.open": "Delete account…",
  "set.acctDel.title": "Delete account and all data",
  "set.acctDel.body": "This permanently removes your account: every child profile and its records, photos, saved stories and comics, coach conversations, and your subscription record. Store payment records are kept only where the law requires. This cannot be undone.",
  "set.acctDel.typeToConfirm": "Type {word} to confirm",
  "set.acctDel.confirmWord": "DELETE",
  "set.acctDel.confirm": "Permanently delete",
  "set.acctDel.done": "Your account and data were deleted.",
  "set.acctDel.partialTitle": "Some data could not be removed yet",
  "set.acctDel.partialBody": "The counts below are real — nothing is hidden. Your account is still active so you can try again.",
  "set.acctDel.retry": "Try again",
  "set.acctDel.receipt": "{deleted} records removed across {classes} data stores.",
  "set.acctDel.failedList": "Could not remove: {classes}",
  ...
  // TODAY-5/PLAT-4/CODEX-6 — QuickLogModal confirmed-capture review copy,
  // migrated from an inline he-ternary object. CODEX-7: the source line stays
  // a factual provenance statement — no confidence/certainty wording may
  ...
  "today.action.notToday": "Not today",
  "today.action.receipt": "Saved as your report",
  "today.action.adapt": "Arbor will use this outcome to shape the next step — never to score your child.",
  "today.action.remove": "Remove",
  ...
  "noticed.calm.body": "No recurring pattern stands out yet. Keep adding moments when they feel useful — the picture grows over time.",
  ...
  // UC-4 — Today dashboard quick cards (Day Windows + Reminders surfaced on Today).
  "today.card.windows.title": "Day Windows",
  "today.card.windows.desc": "Calmer and trickier stretches, from what you've logged.",
  "today.card.reminders.title": "Reminders",
  "today.card.reminders.desc": "Choose when and how Arbor's gentle nudges reach you.",
  ...
  "ob.step.child.subtitle": "Two quick things, and Arbor starts getting to know your child.",
  ...
  "plan.eyebrow": "Behaviors",
  "dev.watching.line": "Review what you've noticed about {name}'s development",
  "dev.watching.lineGeneric": "Review what you've noticed about your child's development",
  "dev.watching.cta": "Open Development Check",
  "lang.vocabEmptyTitle": "Jot a word or phrase {first} says and you'll watch their vocabulary grow here.",
  "lang.vocabEmptyNote": "Totally optional, and always private to you.",
  ...
  "cp.ms.progress": "{checked} of {total} milestones noticed for age {age}.",
  ...
  "prac.speech.voiceConsent.title": "Instant listening needs your OK",
  "prac.speech.voiceConsent.body": "Instant listening uses the speech service built into this device, so {name}'s recording leaves the phone to be turned into text. Until you allow it, nothing is sent anywhere — you score each try yourself, right below.",
  "prac.speech.voiceConsent.uses": "The device's speech service turns the recording into text, so Arbor can suggest how the sound came out.",
  "prac.speech.voiceConsent.stores": "Arbor keeps the practice score — never the recording.",
  "prac.speech.voiceConsent.controls": "You can turn this off anytime in My Child › Privacy. Practice keeps working without it.",
  "prac.speech.voiceConsent.checkbox": "I'm {name}'s parent or guardian, and I allow speech recognition during practice.",
  "prac.speech.voiceConsent.cta": "Allow instant listening",
  "prac.speech.voiceConsent.error": "That didn't save — practice continues with your own scoring.",
  ...
  "nav.sub.learn": "Expert guidance, matched to where you are",
  "nav.short.behaviors": "Behaviors",
  "nav.short.journal": "Journal",
  "nav.short.profile": "Profile",
  "nav.short.stories": "Stories",
  ...
  // UC-6: the global TOOLS drawer was removed — its `nav.tools` / `nav.tool.*`
  // keys are gone. Each tool is now a hub contextual pill labelled via
  // `nav.tab.<tab>` (Shell › hubTabsForSection).
  "nav.popover.language": "Language",
  "nav.popover.settings": "Settings",
  "nav.popover.more": "More",
  "today.meta": "A calm next step, together",
  "today.begin": "Begin",
  "today.guidance.tag": "Today's guidance",
  "today.feed.title": "{name}'s activity",
  "today.feed.eyebrow": "Try together",
  "today.live": "Live",
  "rhythm.peak": "Trickier around {hour}",
  "rhythm.steady": "Fairly steady lately",
  "academy.lessons": "{n} lessons",
  "coach.more": "More",
  "beh.captureTitle": "Log a behavior",
  "beh.coRegScript": "Co-regulation script",
  "beh.day.sun": "Sun",
  "beh.day.mon": "Mon",
  "beh.day.tue": "Tue",
  "beh.day.wed": "Wed",
  ...
  "beh.day.fri": "Fri",
  "beh.day.sat": "Sat",
  "beh.time.morning": "Morning",
  "beh.time.afternoon": "Afternoon",
  "beh.time.evening": "Evening",
  "beh.time.night": "Night",
  "today.intent.doNow": "Do now",
  "today.intent.playFallback": "Today's play quest",
  "today.intent.captureTitle": "Capture one moment",
  "today.intent.ctaPlay": "Open play",
  "today.intent.ctaCapture": "Open journal",
  "today.intent.why": "Why this fits",
  "today.intent.whyRhythm": "Chosen from today's rhythm, recent moments, age, goals, and interests.",
  "today.intent.whySimple": "Chosen from age, goals, interests, and what you've captured so far.",
  "today.intent.remembers": "Arbor remembers",
  "today.intent.memoryLine": "{captured} captured today · {week} this week · {story} in the story.",
  ...
  "today.coach.reply": "Ask Arbor",
  "today.devmap.empty": "Check off milestones in Growth and your picture starts here.",
  "today.feed.empty": "Your logs and {name}'s play will show up here.",
  // TODAY-5/PLAT-4/CODEX-6 — ProgressNarrative copy migrated from an inline
  // he-ternary object. Firewall: counts-only framing, never a score/percentile.
  "today.narrative.eyebrow": "The developing picture",
  "today.narrative.title": "What changed for {name}",
  "today.narrative.changed": "What changed",
  "today.narrative.evidence": "Your evidence",
  ...
  "today.narrative.parentOnly": "Based only on what you recorded — never a score, percentile, or diagnosis.",
  "nav.tab.routines": "Routines",
  "routines.eyebrow": "Routines",
  "routines.title": "Ready-made Routines",
  "routines.sub": "Seven research-backed routines — pick one, make it yours, run it with {name}.",
  ...
  "routines.assigned": "✓ Routine assigned to {name}.",
  "devscore.stat.focus": "Your goals",
  "devscore.stat.domains": "Areas (of 7)",
  "devscore.stat.week": "Logged this week",
  ...
  "beh.stats.contexts": "Contexts",
  "beh.stats.resolved": "Resolved",
  "beh.next.eyebrow": "Your next step",
  "beh.next.title": "Turn one moment into something useful",
  "beh.next.body": "Capture what happened, review only patterns supported by your notes, then try a plan you can adjust.",
  "beh.next.log": "Log what happened",
  "beh.next.plan": "Open action plans",
  "beh.next.capture": "Capture the situation",
  "beh.next.notice": "Review what repeats",
  "beh.next.try": "Try and adjust a plan",
  "growth.focus.eyebrow": "This week's focus",
  "growth.focus.empty.title": "Build the next useful observation",
  "growth.focus.empty.body": "A short Development Check can help you choose one everyday activity to try next.",
  ...
  "journal.storyDraft.title": "This week's story draft",
  "journal.storyDraft.body": "{week} new signals this week, {total} total in {name}'s story. Arbor keeps them organized for review.",
  "journal.storyDraft.cta": "Open story",
  ...
  "journal.week.title": "This week in the story",
  "journal.week.sub": "moments and insights kept in one calm place",
  "journal.compose.eyebrow": "New moment",
  "journal.timeline.title": "Timeline",
  "journal.timeline.count": "moments",
  "timeline.density.feed": "Feed",
  "timeline.density.story": "Story",
  "timeline.density.aria": "Timeline density",
  // JRNL-3 — timeline signal labels/templates (signalTimeline stays pure; both
  // densities label structured signals through these keys at render).
  "timeline.ongoing": "Ongoing",
  "timeline.kind.moment": "Moment",
  "timeline.kind.milestone": "Milestone",
  "timeline.kind.plan": "Plan",
  "timeline.kind.memory": "Memory",
  "timeline.kind.coach": "Coach",
  "timeline.kind.play": "Play",
  "timeline.filter.all": "All",
  "timeline.filter.moment": "Moments",
  "timeline.filter.milestone": "Milestones",
  "timeline.filter.plan": "Plans",
  "timeline.filter.play": "Play",
  "timeline.filter.memory": "Memory",
  "timeline.filter.coach": "Coach",
  "timeline.title.moment": "Logged moment",
  "timeline.title.observed": "Observed: {title}",
  "timeline.title.plan": "Growth plan",
  "timeline.title.memory": "Approved to memory",
  "timeline.title.coach": "Coach session",
  "timeline.title.played": "Played: {title}",
  "timeline.detail.builds": "Builds {domain}",
  "timeline.meta.steps": "{done}/{total} steps",
  "timeline.meta.minutes": "{n} min",
  "timeline.meta.match": "matched to a recent pattern",
  "timeline.playdomain.regulation": "regulation",
  "timeline.playdomain.language": "language",
  ...
  /* ════ KID-1 — Kid Mode chrome (kid register, comic voice — NEVER referenced
     ...
     of KidDashboard.tsx / KidModeOverlay.tsx / HoldExitButton.tsx. ════ */
...
export const he: Dict = {
  ...
  "nav.tab.learn": "ספרייה",
  "nav.tab.smart-reminders": "תזכורות עדינות",
  "nav.tab.science": "המדע",
  // Learn Library
  "learn.title": "ספריית הלמידה",
  "learn.subtitle": "קריאות קצרות ומבוססות־ידע על איך ילדים גדלים — בגודל הדקות שבאמת יש לכם.",
  "learn.search": "חיפוש נושאים…",
  "learn.pickedTitle": "נבחרו עבור {name}",
  "learn.yourChild": "הילד שלכם",
  "learn.whyAge": "נבחרו לפי הגיל של {name}.",
  "learn.whyFull": "נבחרו לפי הגיל של {name} ומפת ההתפתחות שלכם.",
  "learn.all": "הכול",
  "learn.saved": "שמורים",
  "learn.allReads": "עיון בספרייה",
  "learn.count": "{n} קריאות",
  "learn.minutes": "{n} דק׳",
  "learn.ages": "גילאי {min}–{max}",
  "learn.readCard": "לקריאה",
  "learn.back": "חזרה לספרייה",
  "learn.keyPoints": "הנקודות המרכזיות",
  "learn.fullRead": "הקריאה המלאה",
  "learn.tryToday": "לנסות היום",
  "learn.save": "שמירה",
  "learn.savedLabel": "נשמר",
  "learn.share": "שיתוף",
  "learn.copied": "הועתק",
  "learn.emptySearch": "אין עדיין קריאות שתואמות ל“{q}”.",
  "learn.clearSearch": "ניקוי החיפוש",
  "learn.emptySaved": "עוד לא נשמר דבר. הקישו על הסימנייה שעל כרטיס כדי לשמור אותו כאן.",
  "learn.provenance": "חינוך התפתחותי כללי מהספרייה המאוצרת של ארבור — לא הערכה של הילד שלכם. אם משהו ממשיך להדאיג, שיחה עם איש מקצוע היא תמיד צעד טוב.",
  // Practice Studio (parent launcher)
  "practice.studio.title": "סטודיו תרגול",
  "practice.studio.subtitle": "עשרה עולמות מיומנות ש{name} משחק בהם כגיבור. בחרו מוקד, העבירו את המכשיר, או הפעילו מצב ילדים.",
  "practice.studio.kidmode.title": "מצב ילדים",
  "practice.studio.kidmode.sub": "מרחב המשחק הנעול להורים — הילד לא יכול לצאת או למחוק דבר.",
  "practice.studio.kidmode.cta": "הפעלת מצב ילדים",
  "practice.studio.worlds": "העולמות",
  "practice.studio.count": "{n} עולמות",
  "practice.studio.sessions": "{n} מפגשים",
  "practice.studio.openDirect": "פתיחה עכשיו",
  "practice.studio.openKidmode": "במצב ילדים בתור “{world}”",
  "practice.studio.note": "תרגול הוא משחק, לא הערכה — המפגשים מזינים את אותה תמונת התפתחות שאתם כבר רואים, תמיד כספירות, לעולם לא כציון.",
  "practice.world.speech.name": "דיבור וצלילים",
  "practice.world.speech.skill": "תרגול הגייה וצלילים עם משוב מיידי וידידותי.",
  "practice.world.words.name": "עולם המילים",
  "practice.world.words.skill": "אסטרטגיות שפה יומיומיות, מתורגלות דרך משחק.",
  "practice.world.feelings.name": "מעבדת רגשות",
  "practice.world.feelings.skill": "לתת שם לרגשות ולהתמודד איתם, סצנה משחקית אחת בכל פעם.",
  "practice.world.mimic.name": "סטודיו חיקוי",
  "practice.world.mimic.skill": "חיקוי והבעה — חדר הכושר של הכוונון החברתי.",
  "practice.world.adventures.name": "מסע סיפורים",
  "practice.world.adventures.skill": "הבנת הנשמע דרך הרפתקאות סיפוריות.",
  "practice.world.memory.name": "זיכרון עבודה",
  "practice.world.memory.skill": "להחזיק מידע ולהשתמש בו — משחקי התאמה וזיכרון.",
  "practice.world.reading.name": "אותיות וקריאה",
  "practice.world.reading.skill": "צלילי אותיות, מילים שכיחות ושרטוט אותיות, שנרקחים למילים.",
  "practice.world.rhythm.name": "קצב ותזמון",
  "practice.world.rhythm.skill": "לשמור על הקצב — תזמון, קשב ותיאום.",
  "practice.world.movement.name": "תנועה ותנוחות",
  "practice.world.movement.skill": "משחק מוטורי גס: שיווי משקל, תנוחות ושליטה בגוף.",
  "practice.world.logic.name": "דפוסים והיגיון",
  "practice.world.logic.skill": "זיהוי דפוסים — חשיבה מוקדמת של היגיון ומתמטיקה.",
  "learn.whyFullLogs": "נבחרו לפי הגיל של {name}, מפת ההתפתחות שלכם והרגעים שתיעדתם.",
  "learn.whyAgeLogs": "נבחרו לפי הגיל של {name} והרגעים שתיעדתם.",
  "learn.askContext": "תיעדנו לאחרונה גם רגעים קשורים — קחו אותם בחשבון.",
  "learn.listen": "האזנה",
  "learn.listening": "עצירה",
  "learn.addToday": "הוספה להיום",
  "learn.addedToday": "נוסף להיום",
  "learn.pulseAsk": "האם הקריאה עזרה?",
  "learn.pulseYes": "עזרה",
  "learn.pulseNo": "לא ממש",
  ...
  "learn.trailAll": "לפתיחת הספרייה",
  "today.action.eyebrow.learn": "מתוך קריאה בספרייה",
  "nav.short.home": "בית",
  ...
  "consult.reviewed": "עברתי על הסיכום ובחרתי מה לשתף.",
  "consult.contract.review": "סוקרים קודם",
  "consult.contract.reviewBody": "קוראים את הסיכום המדויק לפני שהעתקה, הורדה, ייצוא או שליחה נפתחים.",
  "consult.contract.control": "אתם בוחרים",
  "consult.contract.controlBody": "בטלו כל פרט. ארבור שומר על הסיכום שימושי בלי לשתף יותר מדי.",
  ...
  "coach.online": "תמיד כאן",
  "coach.ready": "כאן בשבילכם בכל צעד עם {name}.",
  "coach.languageManaged": "שפת האפליקציה והאימון מנוהלת בהגדרות.",
  "coach.contract.context": "קורא הקשר",
  "coach.contract.contextBody": "משתמש בפרופיל, רגעים, אבני דרך וזיכרון שאושר כשיש כאלה.",
  "coach.contract.next": "נותן צעד אחד",
  "coach.contract.nextBody": "הופך את התשובה למשהו שאפשר לנסות היום.",
  "coach.contract.memory": "מבקש לזכור",
  "coach.contract.memoryBody": "עובדות מתמשכות מחכות לאישורכם לפני שהן הופכות לזיכרון.",
  "coach.contract.care": "מפנה לטיפול",
  "coach.contract.careBody": "כשעדיף איש מקצוע, ארבור מפנה לרשת הטיפול.",
  ...
  "coach.approve": "אישור",
  "coach.reject": "דחייה",
  "coach.memEmpty": "שאלו את המאמן שאלה, וארבור תציע מה כדאי לזכור — לאישור שלכם. עדיין לא נשמר דבר.",
  ...
  "coach.error": "ארבור לא הצליחה להביא תשובה כרגע. השאלה שלכם נשמרה — נסו שוב.",
  "coach.retry": "נסו שוב",
  ...
  // COACH-1 — CoachAnswerCards panel chrome (he). FLAG: native-Hebrew review before
  ...
  "coach.cards.frame": "מסגרת התפתחותית",
  ...
  "coach.frame.aim": "מטרה",
  "coach.frame.twoAxes": "חום ↔ מבנה",
  "coach.frame.story": "סיפור",
  "coach.frame.shadow": "רגש קשה",
  "coach.frame.marriage": "הורות משותפת",
  "coach.frame.shepherd": "מי מוביל בהמשך",
  // COACH-1 — prominent escalation panel headline (he). Escalation semantics
  // preserved: a clear "reach out for professional help if" call, never a grade.
  "coach.escalate.headline": "פנו לעזרה מקצועית אם",
  // COACH-1 — CoachTab toasts (he).
  "coach.toast.planSeeded": "הנושא נשתל במחולל התוכניות — הקישו על יצירה",
  "coach.toast.draftingLog": "מכינים טיוטת תיעוד מהרגע הזה…",
  "coach.toast.logDrafted": "ארבור הכינה טיוטת תיעוד — בדקו ושמרו",
  "coach.toast.notePrefilled": "תעדו את הרגע — הערה מולאה מראש",
  ...
  "coach.lens.fewer": "פחות אפשרויות",
  // COACH-1 — TrustSafetyBar note under the coach thread (he).
  "coach.trust.note": "הקריאה של ארבור לתשובה הזו",
  // COACH-1 — TrustSafetyBar (he). Posture lines only — never a graded child
  // verdict (clinical firewall). FLAG: native-Hebrew review before wide release.
  "kit.trust.elevated": "שווה שיחה עם איש מקצוע",
  "kit.trust.calm": "תצפיות הורים — לא אבחנה",
  "kit.trust.nonDiagnostic": "הכוונה לא-אבחנתית",
  "kit.trust.escalation": "פנייה לאיש מקצוע זמינה",
  "kit.trust.talkPro": "דברו עם איש מקצוע ←",
  // surf-ask: Scholar Frameworks (lens library inside Ask)
  "scholar.back": "שאל את ארבור",
  "scholar.eyebrow": "שאל את ארבור · ספריית עדשות",
  "scholar.title": "מסגרות מומחים",
  "scholar.subtitle": "עשרות שנים של חוכמה התפתחותית, עדשה אחת בכל פעם. בחרו מומחה כדי להביא את נקודת המבט שלו — ושאלת דוגמה — ישירות אל שאל את ארבור.",
  ...
  "beh.capture.hideDetails": "פחות פרטים",
  ...
  "beh.analyze": "למצוא את הדפוס",
  "beh.synthesizing": "מחברים את התמונה…",
  ...
  "beh.generateScript": "קבלו מילים לרגע הזה",
  "beh.regenerateScript": "נסו ניסוח אחר",
  "beh.analyzing": "מחפשים את הדפוס…",
  ...
  "hm.cat.limits": "גבולות",
  "hm.cat.relationships": "מערכות יחסים",
  "hm.cat.separation": "פרידות",
  "hm.cat.routines": "שגרה",
  "hm.cat.transitions": "מעברים",
  "hm.section.doNow": "מה לעשות עכשיו",
  "hm.section.sayThis": "מה לומר",
  "hm.section.avoid": "ממה להימנע",
  ...
  "hm.today.eyebrow": "מהרגעים האחרונים שתיעדתם",
  // Language Lab (lang.*)
  ...
  "lang.otherTag": "חשיפה",
  "lang.noLangs": "עדיין לא הוגדרו שפות עבור {first}. הוסיפו את השפות המדוברות בבית בפרופיל, והתרגול היומי למטה יתאים את עצמו אליהן.",
  ...
  "ms.all": "הכל",
  "ms.observed": "נצפה",
  "ms.observePrompt": "מה ראיתם?",
  "ms.observe.yes": "כן",
  "ms.observe.notSure": "לא בטוחים",
  "ms.observe.notYet": "עוד לא",
  ...
  "ms.aheadBand": "בהמשך",
  "plan.title": "תוכניות פעולה",
  "plan.subtitle": "הפכו אתגר חוזר לתוכנית רגועה, צעד אחר צעד, עם המילים המדויקות לומר.",
  ...
  "screen.cancel": "ביטול",
  "screen.seeResult": "לתוצאה",
  "screen.answer.yes": "כן",
  "screen.answer.sometimes": "לפעמים",
  "screen.answer.not_yet": "עדיין לא",
  "screen.result.title.watch": "כמה תחומים ששווה לדבר עליהם",
  "screen.result.title.calm": "שום דבר לא בולט אצל {name} בתחומים האלה כרגע",
  "screen.result.body.watch": "זו אינה אבחנה — זו הזמנה לבדוק עם איש מקצוע, וזה אף פעם לא מזיק.",
  "screen.result.body.calm": "המשיכו לשים לב ובדקו שוב בעוד כמה שבועות. התפתחות משתנה מהר.",
  "screen.chip.watch": "שווה שיחה",
  "screen.chip.calm": "אין מה להעלות",
  "screen.next.title": "הצעד הבא שלכם",
  "screen.next.summary": "הכנת סיכום לאיש מקצוע",
  "screen.next.findPro": "חיפוש איש מקצוע",
  "screen.next.retake": "בדיקה מחדש",
  ...
  "screen.monitor.note.milestone.many": "{n} מיומנויות {area} שנצפות בדרך כלל עד עכשיו עדיין לא צוינו עבור {name}.",
  "screen.monitor.note.pattern": "תיעדתם {n} רגעים עצימים וסוערים בתחום {area} לאחרונה.",
  "screen.monitor.note.close": "ילדים מתפתחים בקצב שלהם וזו אינה אבחנה — פשוט שווה לציין זאת בפני איש המקצוע בביקור הבא.",
  "screen.domain.attachment_regulation": "התקשרות וויסות",
  "screen.domain.language_communication": "שפה ותקשורת",
  "screen.domain.cognition_executive_function": "חשיבה וקשב",
  ...
  "screen.band.3-5": "3–5 שנים",
  "screen.band.5-8": "5–8 שנים",
  "screen.band.8-12": "8–12 שנים",
  "screen.item.b01-soc1": "מחייך/ת אליכם בחזרה ומחפש/ת את הפנים שלכם.",
  "screen.item.b01-lang1": "משמיע/ה קולות, מלמל/ת ומגיב/ה בקולות הלוך ושוב איתכם.",
  "screen.item.b01-att1": "נרגע/ת עם הרגעה ממבוגר מוכר.",
  "screen.item.b01-mot1": "מושיט/ה יד לצעצועים ועוקב/ת עם העיניים אחרי דברים.",
  "screen.item.b01-cog1": "מחפש/ת צעצוע או פנים שהוסתרו או הוזזו.",
  "screen.item.b12-lang1": "משתמש/ת בכמה מילים ומנסה לחקות מילים שאתם אומרים.",
  "screen.item.b12-soc1": "מצביע/ה כדי להראות לכם משהו מעניין.",
  "screen.item.b12-soc2": "מביט/ה בכם ומשתף/ת חיוך במהלך משחק (קשב משותף).",
  "screen.item.b12-mot1": "הולך/ת לבד ויציב/ה על הרגליים.",
  "screen.item.b12-cog1": "מבצע/ת הוראה פשוטה כמו 'תן לי את הכדור'.",
  "screen.item.b12-ind1": "נרדם/ת וישן/ה באופן סביר יחסית לגיל.",
  "screen.item.b23-lang1": "מחבר/ת שתי מילים או יותר ('עוד חלב').",
  "screen.item.b23-lang2": "רוב מה שהוא/היא אומר/ת מובן לבני המשפחה.",
  "screen.item.b23-soc1": "שם/ה לב לילדים אחרים ומשחק/ת לידם או איתם.",
  "screen.item.b23-soc2": "מגיב/ה לשמו/ה ויוצר/ת קשר עין בזמן שיחה.",
  "screen.item.b23-att1": "מתאושש/ת מעצב עם עזרה תוך זמן סביר.",
  "screen.item.b23-ind1": "אוכל/ת מגוון סביר של מאכלים ומרקמים.",
  "screen.item.b35-lang1": "מדבר/ת במשפטים קצרים שאדם זר יכול להבין ברובם.",
  "screen.item.b35-soc1": "מחכה לתורו/ה ומשחק/ת משחקי דמיון ושיתוף פעולה עם אחרים.",
  "screen.item.b35-cog1": "מבצע/ת הוראות בנות שני שלבים ונשאר/ת במשימה לזמן קצר.",
  "screen.item.b35-att1": "מתמודד/ת עם רוב המעברים והאכזבות בלי התפרצויות ממושכות.",
  "screen.item.b35-ind1": "מסתדר/ת עם דברים בסיסיים כמו התלבשות, שירותים ושינה בהתאם לגיל.",
  "screen.item.b35-mot1": "מתמודד/ת עם קולות, מרקמים ומקומות הומים מהיום-יום.",
  "screen.item.b58-cog1": "שומר/ת על קשב במשימה ועוקב/ת אחרי שגרות מרובות שלבים.",
  "screen.item.b58-soc1": "יוצר/ת חברויות, שומר/ת עליהן ופותר/ת קונפליקטים קטנים.",
  "screen.item.b58-lang1": "מנהל/ת שיחה הלוך ושוב ועוקב/ת אחרי סיפור.",
  "screen.item.b58-att1": "נרגע/ת אחרי עצב ומתאושש/ת ממכשולים.",
  "screen.item.b58-ind1": "ישן/ה טוב ומסתדר/ת עם שגרת הבוקר ובית הספר בעזרתכם.",
  "screen.item.b812-cog1": "מארגן/ת את שיעורי הבית ומנהל/ת קשב בהתאם לגיל.",
  "screen.item.b812-soc1": "שומר/ת על חברויות ומנווט/ת בין עליות וירידות חברתיות.",
  "screen.item.b812-att1": "מדבר/ת על רגשות ומתאושש/ת מימים קשים.",
  "screen.item.b812-ind1": "מתמודד/ת עם מטלות יום-יומיות וישן/ה מספיק.",
  ...
  "sec.sharing.form.nothingDefault": "שום דבר לא נבחר כברירת מחדל. רק החלקים שתבחרו יהיו גלויים.",
  "sec.sharing.form.what": "מה לשתף",
  "sec.sharing.form.duration": "משך הגישה",
  ...
  "sec.sharing.team.title": "מתואמים סביב {name}",
  "sec.sharing.active.loading": "טוען שיתופים…",
  "sec.sharing.active.empty": "שום דבר לא משותף כרגע. הוסיפו הורה שותף או מורה כדי להתחיל.",
  "sec.sharing.revoke": "ביטול גישה",
  "sec.sharing.noScopes": "ללא הרשאות",
  "sec.sharing.expires": "בתוקף עד {date}",
  "sec.sharing.inbound.title": "שותף איתכם",
  "sec.sharing.inbound.aChild": "ילד/ה",
  "sec.sharing.inbound.fromRole": "מאת {owner} · אתם {role}",
  // CARE-2 — the recipient read-only shared view.
  ...
  "sec.sharing.viewer.error": "לא הצלחנו לטעון את התצוגה המשותפת. נסו שוב.",
  ...
  "sec.sharing.history.revokedOn": "בוטל ב-{date}",
  "sec.sharing.history.expiredOn": "פג תוקף ב-{date}",
  "sec.sharing.audit.shared": "שיתפתם {scopes} עם {email} ({role})",
  "sec.sharing.audit.revoked": "הגישה של {email} בוטלה",
  "sec.sharing.audit.exported": "ייצאתם את כל הנתונים של {name}",
  "sec.sharing.audit.createError": "לא ניתן היה ליצור שיתוף: {message}",
  "sec.sharing.audit.revokeError": "לא ניתן היה לבטל: {message}",
  "share.role.co_parent": "הורה שותף",
  "share.role.viewer": "צופה",
  "share.role.professional": "איש/אשת מקצוע",
  "share.scope.story_timeline": "ציר הסיפור",
  "share.scope.weekly_insight": "תובנה שבועית",
  "share.scope.behavior_patterns": "דפוסי התנהגות",
  "share.scope.milestones": "אבני דרך",
  "share.scope.report_teacher": "תדריך למורה",
  "share.scope.report_therapist": "סיכום למטפל/ת",
  "share.scope.report_pediatrician": "סיכום לרופא/ת ילדים",
  "share.scope.report_slp": "סיכום לקלינאי/ת תקשורת",
  "share.scope.report_behavioral_health": "סיכום לגורם בריאות הנפש",
  "share.duration.30d": "30 ימים",
  "share.duration.60d": "60 ימים",
  "share.duration.term": "עד סוף התקופה",
  "share.duration.until_revoked": "עד לביטול",
  // CARE-1 — מחיקת נתונים אמיתית (GDPR): אישור בהקלדת שם → מחיקה בשרת → קבלה.
  "sec.sharing.delete.btn": "מחיקת נתוני הילד/ה",
  "sec.sharing.delete.title": "מחיקת הנתונים של {name}",
  "sec.sharing.delete.body": "פעולה זו מוחקת לצמיתות את הנתונים של {name} — כל תיעוד, תוכנית, הרשאת שיתוף, רישום הסכמה ואירוע זיכרון, במכשיר הזה ובשרת. לא ניתן לבטל פעולה זו.",
  "sec.sharing.delete.typeToConfirm": "הקלידו {name} לאישור",
  "sec.sharing.delete.confirm": "מחיקה לצמיתות",
  "sec.sharing.delete.working": "מוחק…",
  "sec.sharing.delete.cancel": "ביטול",
  "sec.sharing.delete.error": "משהו השתבש במהלך המחיקה. נסו שוב.",
  "sec.sharing.receipt.title": "המחיקה הושלמה",
  "sec.sharing.receipt.body": "הנתונים של {name} נמחקו לצמיתות בתאריך {date}. שמרו קבלה זו כתיעוד שלכם.",
  "sec.sharing.receipt.memoryEvents": "אירועי זיכרון שנמחקו",
  "sec.sharing.receipt.shares": "הרשאות שיתוף שנמחקו",
  "sec.sharing.receipt.consents": "רישומי הסכמה שנמחקו",
  "sec.sharing.receipt.done": "סיום",
  ...
  "ob.subtitle": "שני דברים מהירים, וארבור מתחילה להכיר את הילד שלכם.",
  "ob.name": "שם הילד",
  ...
  // TODAY-5/PLAT-4 — onboarding progressbar aria-label.
  "ob.progress.step": "שלב {step} מתוך {total}",
  ...
  "set.plan.price.perMonth": "{plan} — {price} לחודש",
  "set.plan.price.perMonthAnnual": "{plan} — {price} לחודש, בחיוב שנתי ({total})",
  "set.plan.cancelAnytime": "אפשר לבטל בכל עת.",
  ...
  "set.plan.restore": "שחזור רכישות",
  "set.plan.restoreDone": "בוצע — המנוי שלכם מעודכן.",
  "set.acctDel.open": "מחיקת חשבון…",
  "set.acctDel.title": "מחיקת החשבון וכל הנתונים",
  "set.acctDel.body": "פעולה זו מוחקת לצמיתות את החשבון: כל פרופילי הילדים והרשומות שלהם, תמונות, סיפורים וקומיקסים שמורים, שיחות עם המאמן ורשומת המנוי. רשומות תשלום נשמרות רק היכן שהחוק מחייב. לא ניתן לבטל פעולה זו.",
  "set.acctDel.typeToConfirm": "הקלידו {word} לאישור",
  "set.acctDel.confirmWord": "מחיקה",
  "set.acctDel.confirm": "מחיקה לצמיתות",
  "set.acctDel.done": "החשבון והנתונים נמחקו.",
  "set.acctDel.partialTitle": "חלק מהנתונים טרם הוסר",
  "set.acctDel.partialBody": "המספרים למטה אמיתיים — דבר לא הוסתר. החשבון עדיין פעיל כדי שתוכלו לנסות שוב.",
  "set.acctDel.retry": "נסו שוב",
  "set.acctDel.receipt": "{deleted} רשומות הוסרו מ-{classes} מאגרי נתונים.",
  "set.acctDel.failedList": "לא ניתן היה להסיר: {classes}",
  ...
  // TODAY-5/PLAT-4/CODEX-6 — QuickLogModal review copy migrated verbatim (HE
  ...
  "noticed.calm.body": "עדיין לא בולט דפוס חוזר. הוסיפו רגעים כשזה מרגיש שימושי — התמונה מתבהרת עם הזמן.",
  ...
  "family.glance.score": "מוכן",
  "family.glance.milestones": "{reached} מתוך {total} אבני דרך",
  "family.glance.nodata": "הפרופיל מוכן",
  "family.glance.active": "פעיל",
  "family.glance.ready": "מוכן",
  ...
  "wk.generating": "מרכיבים את השבוע…",
  ...
  // UC-4 — Today dashboard quick cards (Day Windows + Reminders surfaced on Today).
  "today.card.windows.title": "חלונות היום",
  "today.card.windows.desc": "מקטעים רגועים ומאתגרים יותר, ממה שתיעדתם.",
  "today.card.reminders.title": "תזכורות",
  "today.card.reminders.desc": "בחרו מתי ואיך ההנחיות העדינות של ארבור יגיעו אליכם.",
  ...
  "ob.step.child.subtitle": "שני דברים מהירים, וארבור מתחילה להכיר את הילד שלכם.",
  ...
  "plan.eyebrow": "התנהגות",
  "dev.watching.line": "סקירת מה ששמתם לב אליו בהתפתחות של {name}",
  "dev.watching.lineGeneric": "סקירת מה ששמתם לב אליו בהתפתחות של הילד/ה שלכם",
  "dev.watching.cta": "פתחו את בדיקת ההתפתחות",
  "lang.vocabEmptyTitle": "רשמו מילה או ביטוי ש{first} אומר/ת, וכאן תראו את אוצר המילים גדל.",
  "lang.vocabEmptyNote": "לגמרי אופציונלי, ותמיד פרטי לכם בלבד.",
  ...
  "cp.ms.progress": "{checked} מתוך {total} אבני דרך נצפו לגיל {age}.",
  ...
  "prac.speech.voiceConsent.title": "האזנה מיידית — צריך את האישור שלכם",
  "prac.speech.voiceConsent.body": "ההאזנה המיידית משתמשת בשירות הדיבור המובנה במכשיר, ולכן ההקלטה של {name} יוצאת מהמכשיר כדי להפוך לטקסט. עד שתאשרו, שום דבר לא נשלח לשום מקום — אתם מדרגים כל ניסיון בעצמכם, ממש למטה.",
  "prac.speech.voiceConsent.uses": "שירות הדיבור של המכשיר הופך את ההקלטה לטקסט, כדי שארבור יוכל להציע איך הצליל יצא.",
  "prac.speech.voiceConsent.stores": "ארבור שומר את דירוג התרגול — אף פעם לא את ההקלטה.",
  "prac.speech.voiceConsent.controls": "אפשר לכבות את זה בכל רגע תחת ׳הילד/ה שלי׳ ‹ ׳פרטיות׳. התרגול ממשיך לעבוד גם בלי זה.",
  "prac.speech.voiceConsent.checkbox": "אני ההורה או האפוטרופוס של {name}, ואני מאשר/ת זיהוי דיבור במהלך התרגול.",
  "prac.speech.voiceConsent.cta": "לאשר האזנה מיידית",
  "prac.speech.voiceConsent.error": "האישור לא נשמר — התרגול ממשיך עם הדירוג שלכם.",
  ...
  "nav.sub.learn": "הדרכה ממומחים, מותאמת לאן שאתם נמצאים",
  "nav.short.behaviors": "התנהגות",
  "nav.short.journal": "יומן",
  "nav.short.profile": "פרופיל",
  "nav.short.stories": "סיפורים",
  "nav.short.learn": "למידה",
  "nav.short.more": "עוד",
  "nav.cat.today": "היום",
  ...
  "today.meta": "צעד רגוע אחד, יחד",
  "today.begin": "בואו נתחיל",
  "today.guidance.tag": "ההכוונה של היום",
  "today.feed.title": "הפעילות של {name}",
  "today.feed.eyebrow": "לשחק יחד",
  "today.live": "חי",
  "rhythm.peak": "מאתגר יותר סביב {hour}",
  "rhythm.steady": "יציב יחסית לאחרונה",
  "academy.lessons": "{n} שיעורים",
  "coach.more": "עוד",
  "beh.captureTitle": "תיעוד התנהגות",
  "beh.coRegScript": "תסריט ויסות משותף",
  "beh.day.sun": "א׳",
  "beh.day.mon": "ב׳",
  "beh.day.tue": "ג׳",
  "beh.day.wed": "ד׳",
  ...
  "beh.day.fri": "ו׳",
  "beh.day.sat": "שבת",
  "beh.time.morning": "בוקר",
  "beh.time.afternoon": "צהריים",
  "beh.time.evening": "ערב",
  "beh.time.night": "לילה",
  "today.intent.doNow": "מה עושים עכשיו",
  "today.intent.playFallback": "משימת המשחק של היום",
  "today.intent.captureTitle": "לתעד רגע אחד",
  "today.intent.ctaPlay": "פתחו משחק",
  "today.intent.ctaCapture": "פתחו יומן",
  "today.intent.why": "למה זה מתאים",
  "today.intent.whyRhythm": "נבחר לפי קצב היום, רגעים אחרונים, גיל, מטרות ותחומי עניין.",
  "today.intent.whySimple": "נבחר לפי גיל, מטרות, תחומי עניין ומה שתיעדתם עד עכשיו.",
  "today.intent.remembers": "ארבור זוכר",
  "today.intent.memoryLine": "{captured} תועדו היום · {week} השבוע · {story} בסיפור.",
  ...
  "today.feed.noticedSub": "{title}",
  "today.coach.reply": "שאלו את ארבור",
  "today.devmap.empty": "סמנו אבני דרך במסך הצמיחה והתמונה שלכם מתחילה להיבנות כאן.",
  "today.feed.empty": "היומנים שלכם והמשחק של {name} יופיעו כאן.",
  // TODAY-5/PLAT-4/CODEX-6 — ProgressNarrative copy migrated verbatim (HE
  // rendering byte-identical); counts-only framing, never a score/percentile.
  "today.narrative.eyebrow": "התמונה המתפתחת",
  "today.narrative.title": "מה השתנה אצל {name}",
  "today.narrative.changed": "מה השתנה",
  "today.narrative.evidence": "הראיות שלכם",
  ...
  "routines.eyebrow": "שגרות",
  "routines.title": "שגרות מוכנות",
  "routines.sub": "שבע שגרות מבוססות מחקר — בחרו אחת, התאימו אותה לכם, והריצו עם {name}.",
  ...
  "routines.assigned": "✓ השגרה שויכה ל{name}.",
  "devscore.stat.focus": "היעדים שלכם",
  "devscore.stat.domains": "תחומים (מ-7)",
  "devscore.stat.week": "תועד השבוע",
  "beh.hero.tag": "השבוע",
  "beh.hero.title": "ההתנהגות של {name}",
  "beh.hero.sub": "דפוסים ששמתם לב אליהם — כדי להבין, לא לשפוט.",
  "beh.stats.events": "אירועים",
  "beh.stats.contexts": "הקשרים",
  "beh.stats.resolved": "טופלו",
  "beh.next.eyebrow": "הצעד הבא שלכם",
  "beh.next.title": "הפכו רגע אחד למשהו שימושי",
  "beh.next.body": "תעדו מה קרה, בדקו רק דפוסים שנתמכים בתיעוד שלכם, ואז נסו תוכנית שאפשר להתאים.",
  "beh.next.log": "תעדו מה קרה",
  "beh.next.plan": "פתחו תוכניות פעולה",
  "beh.next.capture": "תעדו את המצב",
  "beh.next.notice": "בדקו מה חוזר",
  "beh.next.try": "נסו והתאימו תוכנית",
  "growth.focus.eyebrow": "המיקוד של השבוע",
  "growth.focus.empty.title": "צרו את התצפית השימושית הבאה",
  "growth.focus.empty.body": "בדיקת התפתחות קצרה יכולה לעזור לבחור פעילות יומיומית אחת לנסות עכשיו.",
  ...
  "journal.storyDraft.title": "טיוטת הסיפור של השבוע",
  "journal.storyDraft.body": "{week} סימנים חדשים השבוע, {total} בסך הכול בסיפור של {name}. ארבור שומר אותם מסודרים לסקירה.",
  "journal.storyDraft.cta": "פתחו סיפור",
  ...
  "journal.week.title": "השבוע בסיפור",
  "journal.week.sub": "רגעים ותובנות שנשמרו במקום אחד",
  "journal.compose.eyebrow": "רגע חדש",
  "journal.timeline.title": "ציר הזמן",
  "journal.timeline.count": "רגעים",
  "timeline.density.feed": "פיד",
  "timeline.density.story": "סיפור",
  "timeline.density.aria": "תצוגת ציר הזמן",
  // JRNL-3 — תוויות ציר הזמן (he).
  "timeline.ongoing": "מתמשך",
  "timeline.kind.moment": "רגע",
  "timeline.kind.milestone": "אבן דרך",
  "timeline.kind.plan": "תוכנית",
  "timeline.kind.memory": "זיכרון",
  "timeline.kind.coach": "מאמן",
  "timeline.kind.play": "משחק",
  "timeline.filter.all": "הכול",
  "timeline.filter.moment": "רגעים",
  "timeline.filter.milestone": "אבני דרך",
  "timeline.filter.plan": "תוכניות",
  "timeline.filter.play": "משחק",
  "timeline.filter.memory": "זיכרון",
  "timeline.filter.coach": "מאמן",
  "timeline.title.moment": "רגע שתועד",
  "timeline.title.observed": "נצפה: {title}",
  "timeline.title.plan": "תוכנית צמיחה",
  "timeline.title.memory": "אושר לזיכרון",
  "timeline.title.coach": "שיחה עם המאמן",
  "timeline.title.played": "שיחקתם: {title}",
  "timeline.detail.builds": "מחזק {domain}",
  "timeline.meta.steps": "{done}/{total} צעדים",
  "timeline.meta.minutes": "{n} דק׳",
  "timeline.meta.match": "הותאם לדפוס מהתקופה האחרונה",
  "timeline.playdomain.regulation": "ויסות",
  "timeline.playdomain.language": "שפה",
