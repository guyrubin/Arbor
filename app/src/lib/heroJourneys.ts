...
export const HERO_STORIES: HeroStorySpec[] = [
  ...
  },
  {
    ...
    origin: "original", ageRange: [4, 8], primaryMetric: "courage", dilemmaType: "courage",
  ...
  },
  {
    ...
    origin: "original", ageRange: [4, 8], primaryMetric: "wisdom", dilemmaType: "prudence",
    baseReward: { wisdom: 2, empathy: 1 },
    ...
    beats: [
      ...
      { id: "decision", title: "Find the Rhythm", titleHe: "למצוא את הקצב", spine: "The hero must help the clouds choose how to make music together.", spineHe: "הגיבור צריך לעזור לעננים לבחור איך ליצור מוזיקה יחד.", choices: [
        { id: "a", label: "Stop and listen quietly for one round", labelHe: "לעצור ולהקשיב בשקט לסיבוב אחד", outcomeHint: "The quiet pause lets everyone notice the beat that was hiding underneath the noise.", outcomeHintHe: "העצירה השקטה מאפשרת לכולם להבחין בפעמה שהסתתרה מתחת לרעש.", metricDeltas: { wisdom: 1 } },
