...
| 4 | **AR-CAP-04** | Separate caregiver identities + alignment | Good Inside-level family collaboration without leaking private adult history | sharing/auth migration design approved — design delivered as [ADR 0005](adr/0005-caregiver-identity-model.md) (CARE-9, wave 3); implementation blocked on GD-9 + DPIA sign-off |
